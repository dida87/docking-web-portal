...
class UserIdentity extends CUserIdentity {
    ...
    public function authenticate() {
        ...
        // here I compare db password with passwod field
            ...
            // pass role funcitons
            $this->setState('protein_user', ($record['protein_user'] > 0) ? true : false);
            $this->setState('ligand_user', ($record['ligand_user'] > 0) ? true : false);
            $this->setState('docking_user', ($record['docking_user'] > 0) ? true : false);
