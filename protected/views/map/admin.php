...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		'file_tar_gz',
                ...
                (
                'update' => array(
                     'visible'=> '(isset(Yii::app()->user->protein_user) && Yii::app()->user->protein_user)',
                ...
                'delete'=> array(
                     'visible'=> '(isset(Yii::app()->user->protein_user) && Yii::app()->user->ligand_user)',
                )
            )
...
<?php
if (isset(Yii::app()->user->protein_user)){
